...
pub fn ts_plan_details_available_page(state: &State) -> Element<'static, MyAppMessage, Theme, Renderer> {
                    ...
                    container(
                        column![
                            row![
                                container(column![
                                    row![
                                        Svg::from_path("assets/create-plan/available_status.svg").width(Length::Fixed(136.)).height(Length::Fixed(25.)),
